...
const SelectRaza = ({ onChangeEspecie, onChangeRaza, errorRaza, register, defaultValue }) => {
  ...
  useEffect(() => {
    if (defaultValue) {
      ...
      if (razaEncontrada) {
        const especieEncontrada = especies.find((es) => es.razas.some((r) => r.id === razaEncontrada.id));

        if (especieEncontrada) {
          setSelectedEspecie(especieEncontrada);
          setSelectedRaza(razaEncontrada);
        } else {
