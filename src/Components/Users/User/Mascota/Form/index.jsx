...
const MascotasForm = () => {
  ...
  const mascotaDataUpdate = {
    fecha_nacimiento: justFecha(dataForm?.fecha_nacimiento),
    nombre: dataForm?.nombre,
    owner: id ? dataForm?.owner : dataForm.id,
    raza: dataForm?.raza,
    sexo: dataForm?.sexo,
  };
  ...
  useEffect(() => {
    setValue("owner", mascotaDataUpdate.owner);
  }, [setValue, mascotaDataUpdate.owner]);
  ...
  const onSubmit = async (data) => {
    ...
    data = { ...data, raza: razaElegida.id,  fecha_nacimiento: dateFormated };
    setFormData(data);
    setShowModal(true);
  };
