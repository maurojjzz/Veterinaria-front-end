...
const TablaAtencion = ({data}) => {
    ...
    return (
      <div className={`d-flex justify-content-center`}>
            ...
            <tbody>
              {data.map((ate, index) => (
                ...
                >
                  ...
                  <td className={`d-none d-sm-table-cell `}>{ate.veterinario.apellido} {ate.veterinario.nombre}</td>
                  ...
                  <td className={`d-none d-md-flex gap-2 ${styles.practicas}`}>
                    ...
                    {ate.practicas.length > 1 ? (<p className={`${styles.masPracticas}`}> + {ate.practicas.length - 1}</p>) :('')}
                  </td>
                  ...
                  <td>
                    <div className={`d-flex align-items-center justify-content-center ${styles.iconCont}`}>
                      <img
                        onClick={(e)=>{e.stopPropagation();console.log('aca el editas')}}
                  ...
                  <td>
                    <div className={`d-flex align-items-center justify-content-center ${styles.iconCont}`}>
                      <img
                        ...
                        onClick={(e)=>{ e.stopPropagation();console.log('aca el borrar')}}
        ...
        {modal && <ModalAtencion setModal={setModal} dataFilaAtencion={dataFilaAtencion} setDataFilaAtencion={setDataFilaAtencion} owners={owner} raza={raza} />}
      </div>
    );
}
